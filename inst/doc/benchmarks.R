...
## ----echo = FALSE, eval = rlang::is_installed("here")-------------------------
...
## ----Generate alt text for benchmarks, echo = FALSE, results = "hide", eval = rlang::is_installed("here")----
